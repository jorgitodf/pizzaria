        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" id="div_cad_end">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <select class="form-control" name="nome_cidade">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <input class="form-control" name="cep" type="text" placeholder="Digite o CEP" value="">
                </div>
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="div_radio">
                    <label class="radio-inline">
                        <input type="radio" name="tipoEndereco" value="1" id="">Casa
                    </label>    
                    <label class="radio-inline">
                        <input type="radio" name="tipoEndereco" value="2" id="">Trabalho
                    </label>    
                </div>
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="div_btn_cad_end">
