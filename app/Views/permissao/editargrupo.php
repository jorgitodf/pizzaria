...
<section class="container col-xs-12 col-lg-12 col-md-12 col-sm-12" id="">
    <aside class="row">
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" id="div_cad_permissao">
            <h2>Editar Grupo de Permissões</h2>
            <div class="form-group " id="">
                <form class="form-login" id="" action="/permissoes/editar/<?php echo $this->view->grupo->id_permissao_grupo; ?>" method="post">
                    <div class="form-group">
                        <input class="form-control input-sm" name="nome_grupo" type="text" placeholder="Digite o nome do Grupo de Permissão" value="<?php echo isset($this->view->grupo) ? $this->view->grupo->nome_grupo : ""; ?>">
                    </div><br/>
                    <div class="form-group" id="div_head_grupo_permissao">
                        ...
                        <?php foreach ($this->view->parametros as $value): ?>
                            ...
                            <input type="checkbox" name="permissoes[]" value="<?php echo $value->id_permissao_parametros; ?>" id="p_<?php echo $value->id_permissao_parametros; ?>"
                                   <?php echo (in_array($value->id_permissao_parametros, $this->view->grupo->parametros))?'checked="checked"': ""; ?>>
                    ...
                    <div class="form-group" id="div_form_cad_permissao">
                        <button type="submit" class="btn btn-primary btn-sm" id="">Salvar</button>
                    </div>
